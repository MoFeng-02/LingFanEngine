...
public static class ExpressionParser
{
    ...
    {
        ArgumentNullException.ThrowIfNull(termFactory);
    ...
    {
        ArgumentNullException.ThrowIfNull(operatorTableFactory);
    ...
    {
        ArgumentNullException.ThrowIfNull(termAndOperatorTableFactory);
