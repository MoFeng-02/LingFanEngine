// ============================================================
// 第三章 - 神秘洞穴 + 三种结局
// 展示：条件结局(good/bad/normal)、shake、transition、NVL 叙事
// ============================================================

scene "cavern"
  set "story.progress" 4
  image "Images/lingfan.png" x=0 y=0 width=100% height=100% opacity=0.7
  ...
  say "那是一块{b}{color=#FFD700}星辰碎片{/color}{/b}——传说中蕴含着巨大力量的遗物。" speaker="旁白"
  nvl exit

  say "晶石似乎感应到了你的到来，光芒开始剧烈跳动。" speaker="旁白"
  transition "zoomin" duration=1.0
  shake intensity=12 duration=0.8
...
label ending_power:
  ...
  shake intensity=22 duration=1.2
  ...
  say "{color=#FF4444}【坏结局：力量之主】{/color}" speaker="系统"
  scene "title_main"
...
label ending_seal:
  ...
  say "{color=#FFD700}【好结局：封印者】{/color}" speaker="系统"
  scene "title_main"
...
label ending_leave:
  ...
  say "{color=#AAAAAA}【普通结局：过客】{/color}" speaker="系统"
  scene "title_main"
