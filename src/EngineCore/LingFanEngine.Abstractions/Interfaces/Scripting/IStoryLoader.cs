...
public interface IStoryLoader
{
    ...
    /// <summary>从 DSL 脚本中提取 scene 块并返回剩余流程脚本（含场景级 Defines、LayoutMode、SceneType）</summary>
    (List<(string SceneName, List<UIElementEntity> Elements, string EntryScript, Dictionary<string, object?>? Defines, string LayoutMode, SceneType SceneType)> Scenes, string FlowScript)
