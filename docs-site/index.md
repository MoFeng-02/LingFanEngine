...
hero:
  name: 灵泛引擎
  text: 高性能视觉小说引擎
  tagline: 基于 .NET 10 + Avalonia 12 · 跨平台 · AOT 友好 · 数据驱动
  actions:
    - theme: brand
      text: 快速开始
...
features:
  ...
  - icon: 📝
    title: DSL 写故事
    details: 专用 .story 脚本语言，文本级回溯，支持内联标记、NVL 模式、对话框模板。
  - icon: 🔧
    title: C# 写扩展
    details: StoryScript 基类 + ICommand 管道，C# 与 DSL 混合开发，双模平权，无限扩展。
  - icon: 🔒
    title: 即解即用加密
    details: AES-256-GCM 资源加密，LFEN 格式，按文件类型勾选，SDK 一键发布。
  - icon: 🎬
    title: 多媒体支持
    details: BGM/SE/Voice/Ambient 音频，视频过场，Live2D 立绘，过渡动画，屏幕震动。通过 LingFan.Media 跨平台 AOT 媒体基础设施库实现。
  - icon: 🌍
    title: 小说世界模式
