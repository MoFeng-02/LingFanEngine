...
scene "trans_demo" type=menu
  ...
  button "淡入 (Fade)" x=50% y=30% width=220 height=42 color="#88CCFF" nav="do_trans_fade"
  button "左滑 (SlideLeft)" x=50% y=40% width=220 height=42 color="#88FF88" nav="do_trans_slide"
  button "右滑 (SlideRight)" x=50% y=50% width=220 height=42 color="#FF88AA" nav="do_trans_slide_right"
  button "缩放 (ZoomIn)" x=50% y=60% width=220 height=42 color="#FFAA88" nav="do_trans_zoom"
