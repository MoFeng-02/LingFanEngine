    ...
    sidebar: {
      ...
      '/tutorial/': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: '06 · 背景立绘与视觉', link: '/tutorial/06-背景立绘与视觉' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: '14 · 自定义对话框模板', link: '/tutorial/14-自定义对话框模板' },
          ],
        },
        {
          text: '发布篇',
      ...
      '/cookbook/': [
        {
          ...
          items: [
            ...
            { text: '如何实现好感度系统', link: '/cookbook/如何实现好感度系统' },
            ...
            { text: '如何迁移 Ren\'Py 项目', link: '/cookbook/如何迁移RenPy项目' },
